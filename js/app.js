...
if (iconMenu != null) {
	...
	let iconSearch = document.querySelector(".icon-header__search");
	let iconPurchases = document.querySelector(".icon-header__purchases");
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			...
			iconPurchases.classList.toggle("_active");
		}
	});
};
function menu_close() {
	...
	iconSearch.classList.remove("_active");
	iconPurchases.classList.remove("_active");
}
//=================
//BodyLock
...
let aDel = document.getElementsByTagName{}
console.log(aDel);
console.log('344');
// aAll =aDel.getElementsByTagName("a")
// console.log(aAll);
// console.log(aAll.length);
